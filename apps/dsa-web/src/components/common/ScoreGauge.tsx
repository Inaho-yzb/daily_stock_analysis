    ...
    <div className={cn('flex flex-col items-center', className)}>
      ...
      <div className="relative" style={{ width, height: width }}>
        <svg
          ...
          width={width}
          height={width}
          style={{ filter: `drop-shadow(0 0 8px ${colors.glowFilter.replace('0.66', '0.28')})` }}
        >
          <defs>
          ...
          <circle
            ...
            strokeWidth={stroke + Math.max(3, gap * 0.55)}
            strokeLinecap="round"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span
            className={cn('font-bold', fontSize, 'text-foreground')}
            style={{ textShadow: `0 0 16px ${colors.glowFilter.replace('0.66', '0.22')}` }}
          >
            {displayScore}
          </span>
          {showLabel && (
